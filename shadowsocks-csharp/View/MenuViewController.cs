...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/nanqinlang-shadowsocksr/shadowsocksr-update/master/pac/ss_lanip.pac");
        }

        private void UpdatePACFromCNWhiteListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/nanqinlang-shadowsocksr/shadowsocksr-update/master/pac/ss_white.pac");
        }

        private void UpdatePACFromCNOnlyListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/nanqinlang-shadowsocksr/shadowsocksr-update/master/pac/ss_white_r.pac");
        }

        private void UpdatePACFromCNIPListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/nanqinlang-shadowsocksr/shadowsocksr-update/master/pac/ss_cnip.pac");
        }
